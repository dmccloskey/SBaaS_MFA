...
class stage02_isotopomer_fittedExchangeFluxes_query(sbaas_template_query):
    def initialize_supportedTables(self):
        '''Set the supported tables dict for ...
        '''
        tables_supported = {'data_stage02_isotopomer_fittedExchangeFluxes':data_stage02_isotopomer_fittedExchangeFluxes,
                            'data_stage02_isotopomer_fittedExchangeFluxStatistics':data_stage02_isotopomer_fittedExchangeFluxStatistics,
                        };
