...
class stage02_isotopomer_measuredData_query(sbaas_template_query):
    def initialize_supportedTables(self):
        '''Set the supported tables dict for ...
        '''
        tables_supported = {'data_stage02_isotopomer_measuredFluxes':data_stage02_isotopomer_measuredFluxes,
                            'data_stage02_isotopomer_measuredPools':data_stage02_isotopomer_measuredPools,
                            'data_stage02_isotopomer_measuredFragments':data_stage02_isotopomer_measuredFragments,
                        };
